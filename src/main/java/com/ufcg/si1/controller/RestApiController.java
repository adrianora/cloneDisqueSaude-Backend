...
public class RestApiController {
    ...
    public ResponseEntity<?> updateQueixa(@PathVariable("id") long id, @RequestBody Queixa queixa) {
        ...
        if (currentQueixa == null) {
        	...
        	return new ResponseEntity(new CustomErrorType("Unable to upate. Queixa with id " + id + " not found."), HttpStatus.NOT_FOUND);
        }
    ...
    public ResponseEntity<?> deleteUser(@PathVariable("id") long id) {
        ...
        if (user == null) {
            ...
            return new ResponseEntity(new CustomErrorType("Unable to delete. Queixa with id " + id + " not found."), HttpStatus.NOT_FOUND);
        }
    ...
    public ResponseEntity<?> consultarEspecialidade(@PathVariable("id") long id) {
        ...
        if (q == null) {
            ...
            return new ResponseEntity(new CustomErrorType("Especialidade with id " + id + " not found"), HttpStatus.NOT_FOUND);
        }
    ...
    public ResponseEntity<?> consultarUnidadeSaude(@PathVariable("id") long id) {
        ...
        if (us == null) {
            ...
            return new ResponseEntity(new CustomErrorType("Unidade with id " + id + " not found"), HttpStatus.NOT_FOUND);
        }
    ...
    public ResponseEntity<?> consultarUnidadeSaudePorBairro(@RequestParam(value = "bairro", required = true) String bairro){
        ...
        if (us == null && !(us instanceof UnidadeSaude)) {
            ...
            return new ResponseEntity(new CustomErrorType("Unidade with bairro " + bairro + " not found"), HttpStatus.NOT_FOUND);
        }
